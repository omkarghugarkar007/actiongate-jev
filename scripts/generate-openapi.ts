...
const operations: Record<string, Partial<Record<"get" | "post" | "put" | "delete", OperationSpec>>> = {
  ...
  "/v1/simulate": { post: { summary: "Run a decision without storing it or issuing a grant", roles: ["policy_admin"], responses: { "200": { description: "Simulated decision" }, "403": { description: "Risk or operation downgrade, or missing role" }, "409": { description: "The candidate policy does not contain the tool" } } } },
